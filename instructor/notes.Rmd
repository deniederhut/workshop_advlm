...
The actual prediction equation here should be `y = 0.5 + x`, but because the errors around y are non-normal, linear regression produces an incorrect solution something like `r model.toy$coef[[1]] + model.toy$coef[[2]]`x. This *usually* cannot be corrected by nonlinear transforms.
